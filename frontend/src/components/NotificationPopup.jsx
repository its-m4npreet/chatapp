...
const NotificationPopup = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-start justify-end bg-black pt-16 sm:pr-4 p-2">
      {/* Backdrop */}
                      ...
                      {notification.type === "group_invite" &&
                        notification.status === "pending" && (
                          <div className="flex gap-2 mt-3">
                            ...
                            <button
                              onClick={() =>
                                handleDeclineGroupInvite(notification)
                              }
                              disabled={actionLoading[notification._id]}
