...
const EditGroupModal = ({
  ...
  const handleToggleAdmin = async (memberId, isCurrentlyAdmin) => {
    const action = isCurrentlyAdmin ? "remove as an admin" : "make an admin";
    ...
    try {
      ...
      // Refresh group data to show updated admin status
      if (onGroupUpdated) onGroupUpdated();
    } catch (err) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center bg-black/70">
      <div className="w-full max-w-lg bg-zinc-800 sm:rounded-xl rounded-t-2xl shadow-2xl border-t sm:border border-gray-700 h-[95vh] sm:h-auto sm:max-h-[90vh] flex flex-col">
        {/* Header */}
        <div className="flex items-center justify-between px-3 sm:px-4 py-3 border-b border-gray-700 shrink-0">
        ...
        <div className="flex border-b border-gray-700 shrink-0">
          <button
            ...
            className={`flex-1 px-3 sm:px-4 py-2 sm:py-3 text-sm font-medium transition ${
              activeTab === "general"
        ...
        {/* Error Message */}
        {error && (
          <div className="mx-3 sm:mx-4 mt-4 p-3 bg-red-500/10 border border-red-500/30 rounded-lg text-red-400 text-sm shrink-0">
            {error}
          </div>
        )}
            ...
            <div className="space-y-4">
              <div className="flex justify-center">
                <div className="relative">
                  <div className="w-20 h-20 sm:w-24 sm:h-24 rounded-full bg-blue-600 flex items-center justify-center overflow-hidden">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full bg-zinc-700 text-white px-4 py-2 rounded-lg outline-none border border-gray-600 focus:border-blue-500 disabled:opacity-50 disabled:cursor-not-allowed text-sm sm:text-base"
                />
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={3}
                  disabled={!isCreator && !isAdmin}
                  className="w-full bg-zinc-700 text-white px-4 py-2 rounded-lg outline-none border border-gray-600 focus:border-blue-500 resize-none disabled:opacity-50 disabled:cursor-not-allowed text-sm sm:text-base"
                />
                <p className="text-gray-500 text-xs mt-1 text-right">
            ...
            <div className="space-y-2">
              {members.map((member) => {
                ...
                return (
                  <div
                    key={member._id}
                    className="flex items-center gap-3 p-2 sm:p-3 rounded-lg hover:bg-zinc-700 transition"
                  >
                      ...
                      <div className="flex items-center gap-2 shrink-0">
                        {isCreator && (
                          <button
                            ...
                            className={`p-2 rounded-lg transition ${isMemberAdmin ? "bg-green-600/20 text-green-500 hover:bg-green-600/30" : "bg-zinc-600 text-gray-400 hover:bg-zinc-500 hover:text-white"}`}
                            title={
